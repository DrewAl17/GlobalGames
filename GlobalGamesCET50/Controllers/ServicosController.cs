...
namespace GlobalGamesCET50.Controllers
{
    public class ServicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Mensagens")] Servicos servicos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Mensagens")] Servicos servicos)
        {
            if (id != servicos.Id)
            {
                return NotFound();
